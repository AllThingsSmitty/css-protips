...
1. [Create a Simple Wrapper Utility Class](#create-a-simple-wrapper-utility-class)
...
### Create a Simple Wrapper Utility Class

Most webpages use some sort of wrapper which gives the content margins and centers it on the page. This simple utility class from [Kaloyan Kosev](https://css-tricks.com/best-way-implement-wrapper-css/) does just that.
